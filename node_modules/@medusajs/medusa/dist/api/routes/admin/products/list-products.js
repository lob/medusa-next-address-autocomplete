...
exports.AdminGetProductsParams = exports.AdminGetProductsPaginationParams = exports.ProductStatus = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedParams, productService, includeFields, expandFields, listConfig, orderField, _a, field, filterableFields, _b, products, count;
    var _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0: return [4 /*yield*/, (0, validator_1.validator)(AdminGetProductsParams, req.query)];
            case 1:
                validatedParams = _e.sent();
                ...
                listConfig = {
                    select: (includeFields.length
                        ? includeFields
                        : _1.defaultAdminProductFields),
                    relations: expandFields.length
                        ? expandFields
                        : _1.defaultAdminProductRelations,
                    skip: validatedParams.offset,
                    take: validatedParams.limit,
                };
                if (typeof validatedParams.order !== "undefined") {
                    orderField = validatedParams.order;
                    if (validatedParams.order.startsWith("-")) {
                        _a = __read(validatedParams.order.split("-"), 2), field = _a[1];
                        orderField = field;
                        listConfig.order = (_c = {}, _c[field] = "DESC", _c);
                    }
                    else {
                        listConfig.order = (_d = {}, _d[validatedParams.order] = "ASC", _d);
                    }
                    if (!_1.allowedAdminProductFields.includes(orderField)) {
            ...
            case 2:
                _b = __read.apply(void 0, [_e.sent(), 2]), products = _b[0], count = _b[1];
                res.json({
                    products: products,
                    count: count,
...
var AdminGetProductsParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsEnum)(ProductStatus, { each: true }),

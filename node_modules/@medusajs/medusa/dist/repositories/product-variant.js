            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(Object.entries(groupedRelations).map(function (_a) {
                            ...
                            var querybuilder = _this.createQueryBuilder("pv");
                            querybuilder = querybuilder.leftJoinAndSelect("pv.".concat(toplevel), toplevel);
                            try {
                            ...
                            if (withDeleted) {
                                ...
                                querybuilder = querybuilder.where("pv.deleted_at IS NULL AND pv.id IN (:...entitiesIds)", {
                                    entitiesIds: entityIds,
                                });
                            }

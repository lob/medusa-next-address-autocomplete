...
var CustomerResource = /** @class */ (function (_super) {
     ...
     */
    CustomerResource.prototype.create = function (payload) {
     ...
     * @return {ResponsePromise<StoreCustomersRes>}
     */
    CustomerResource.prototype.retrieve = function () {
     ...
     * @return {ResponsePromise<StoreCustomersRes>}
     */
    CustomerResource.prototype.update = function (payload) {
        var path = "/store/customers/me";
        return this.client.request("POST", path, payload);
    };
    /**
     ...
     */
    CustomerResource.prototype.listOrders = function (params) {
     ...
     * @return {ResponsePromise<StoreCustomersRes>}
     */
    CustomerResource.prototype.resetPassword = function (payload) {
     ...
     */
    CustomerResource.prototype.generatePasswordToken = function (payload) {

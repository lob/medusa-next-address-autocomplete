# This release is actually [v5.8.4](https://www.npmjs.com/package/ioredis-mock/v/5.8.4)

The [`v5.9.0`](https://www.npmjs.com/package/ioredis-mock/v/5.9.0) release should've been a major release as it contained a breaking change. It's republished as [`v6.0.0`](https://www.npmjs.com/package/ioredis-mock/v/6.0.0). It's too late to unpublish `v5.9.0`, thus the best option is to republish `v5.8.4` as `v5.9.1`. This way projects that currently pull in `v5.9.0` and is breaking, will start pulling in `v5.9.1` and start to recover.
